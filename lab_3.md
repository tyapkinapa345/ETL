...
- **Бизнес-задача** (выявление товаров с высоким процентом возвратов и плохими отзывами) решена с помощью `view_problem_products_alt`, которое выдаёт товары – именно те, которые требуют внимания аналитика.
...
6. Проведён анализ, выявлены товары с признаками проблем.

#### Файлы
- [Job](lab_3/Job_CSV_to_MYsql_lab3.kjb)
- [Трансформация загрузки Returns](lab_3/returns.ktr)
- [Трансформация загрузки Reviews](lab_3/reviews.ktr)
- [Трансформация загрузки Products](lab_3/Postgre_to_Mysql_1.ktr)
